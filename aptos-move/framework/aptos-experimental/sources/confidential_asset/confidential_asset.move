...
module aptos_experimental::confidential_asset {
    ...
    #[view]
    /// This ignores the global auditor, if any, and only returns the asset-specific auditor EK. Also, it returns the
    /// auditor config even if the asset_type is no longer allow-listed.
    public fun get_auditor_config_for_asset_type(
        asset_type: Object<fungible_asset::Metadata>
    ...
    #[view]
    public fun get_global_auditor_config(): AuditorConfig acquires GlobalConfig {

...
module 0x42::mutations {
    ...
    spec increment_global(addr: address) {
        ...
        aborts_if [inferred] global<Counter>(addr).value == MAX_U64;
    ...
    spec different_addr_global(a1: address, a2: address, v1: u64, v2: u64) {
        pragma opaque = true;
        ensures [inferred] global<Counter>(a2) == update_field(S |= global<Counter>(a2), value, v2);
        ensures [inferred] (S |= global<Counter>(a1)) == update_field(old(global<Counter>(a1)), value, v1);
        ensures [inferred = sathard] forall x: address: x != a1 ==> (S |= global<Counter>(x)) == old(global<Counter>(x));
    ...
    spec cond_addr_global_inc(cond: bool, a1: address, a2: address) {
        ...
        aborts_if [inferred] cond && global<Counter>(a1).value == MAX_U64;
        aborts_if [inferred] cond && !exists<Counter>(a1);
        aborts_if [inferred] !cond && global<Counter>(a2).value == MAX_U64;
        aborts_if [inferred] !cond && !exists<Counter>(a2);
        modifies [inferred] global<Counter>(a1);
        modifies [inferred] global<Counter>(a2);
    }
    ...
    spec cond_addr_sequential(cond: bool, a1: address, a2: address, v1: u64, v2: u64) {
        pragma opaque = true;
        ensures [inferred] cond ==> global<Counter>(a2) == update_field(S |= global<Counter>(a2), value, v2);
        ensures [inferred] !cond ==> global<Counter>(a1) == update_field(S |= global<Counter>(a1), value, v2);
        ensures [inferred] cond ==> (forall x: address: x != a1 ==> (S |= global<Counter>(x)) == old(global<Counter>(x)));
        ensures [inferred] cond ==> (S |= global<Counter>(a1)) == update_field(old(global<Counter>(a1)), value, v1);
        ensures [inferred] !cond ==> (forall x: address: x != a2 ==> (S |= global<Counter>(x)) == old(global<Counter>(x)));
        ensures [inferred] !cond ==> (S |= global<Counter>(a2)) == update_field(old(global<Counter>(a2)), value, v1);
    ...
    spec cond_addr_increment(cond: bool, a1: address, a2: address, v1: u64, v2: u64) {
        pragma opaque = true;
        ensures [inferred] cond ==> global<Counter>(a2) == update_field(S |= global<Counter>(a2), value, (S |= global<Counter>(a2)).value + v2);
        ensures [inferred] !cond ==> global<Counter>(a1) == update_field(S |= global<Counter>(a1), value, (S |= global<Counter>(a1)).value + v2);
        ensures [inferred] cond ==> (forall x: address: x != a1 ==> (S |= global<Counter>(x)) == old(global<Counter>(x)));
        ensures [inferred] cond ==> (S |= global<Counter>(a1)) == update_field(old(global<Counter>(a1)), value, old(global<Counter>(a1)).value + v1);
        ensures [inferred] !cond ==> (forall x: address: x != a2 ==> (S |= global<Counter>(x)) == old(global<Counter>(x)));
        ensures [inferred] !cond ==> (S |= global<Counter>(a2)) == update_field(old(global<Counter>(a2)), value, old(global<Counter>(a2)).value + v1);
    ...
    spec triple_addr_global(a1: address, a2: address, a3: address, v1: u64, v2: u64, v3: u64) {
        pragma opaque = true;
        ensures [inferred] global<Counter>(a3) == update_field(S2 |= global<Counter>(a3), value, v3);
        ensures [inferred] (S2 |= global<Counter>(a2)) == update_field(S1 |= global<Counter>(a2), value, v2);
        ensures [inferred] (S1 |= global<Counter>(a1)) == update_field(old(global<Counter>(a1)), value, v1);
        ensures [inferred = sathard] forall x: address: x != a2 ==> (S2 |= global<Counter>(x)) == (S1 |= global<Counter>(x));
        ensures [inferred = sathard] forall x: address: x != a1 ==> (S1 |= global<Counter>(x)) == old(global<Counter>(x));
    ...
    spec mutation_then_call(a1: address, a2: address, v: u64) {
        ...
        ensures [inferred] (S |= global<Counter>(a1)) == update_field(old(global<Counter>(a1)), value, v);
    ...
    spec call_then_mutation(a1: address, a2: address, v: u64) {
        pragma opaque = true;
        ensures [inferred] global<Counter>(a1) == update_field(S |= global<Counter>(a1), value, v);
    ...
    spec remove_and_modify(a1: address, a2: address, v: u64): u64 {
        pragma opaque = true;
        ensures [inferred] result == old(global<Counter>(a1)).value;
        ensures [inferred] global<Counter>(a2) == update_field(S |= global<Counter>(a2), value, v);
